...
describe('UsuarioController', () => {
  ...
  describe('create', () => {
    it('criar um novo usuário', async () => {
      ...
      const mockUsuario = { ...createUsuarioDto, id: 1 };
  ...
  describe('findOne', () => {
    it('obter um usuário', async () => {
      ...
      expect(response.data).toEqual(mockUsuario);
      expect(response.message).toBe(EMensagem.AtualizadoComSucesso);
    });
  });
  ...
  describe('unactivage', () => {
    it('desativar um usuário', async () => {
      ...
      expect(response.message).toBe(EMensagem.DesativadoComSucesso);
    });
  });
});
